...
<section class="section">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('subcategorie.update', $subcategory->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mt-3">
                            ...
                            @if($subcategory->image)
                                <img src="{{ asset($subcategory->image) }}" alt="subCategory Image" width="100" height="100" class="mt-2">
                            @endif
                        </div>
