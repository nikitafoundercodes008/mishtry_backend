...
<div class="modal-body">
    ...
    <form action="{{ route('storeSubcategory') }}" method="POST" enctype="multipart/form-data" class="subcategory-form">
        @csrf 
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="subcategory-name" name="name" required placeholder="Enter subcategory name" value="{{ old('name') }}">
            @error('name')
                <div class="text-danger mt-2">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="file" class="form-control" id="subcategory-image" name="image" required>
            @error('image')
                <div class="text-danger mt-2">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            <label for="subcategory-status" class="form-label">Status</label>
            <select class="form-control" id="subcategory-status" name="status" required>
